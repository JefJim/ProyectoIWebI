...
$sqlDisponibles = "SELECT COUNT(*) AS arboles_disponibles FROM arboles WHERE estado = 0";
$sqlVendidos = "SELECT COUNT(*) AS arboles_vendidos FROM arboles WHERE estado = 1";
